...
from dataset import CatDog, SkyDataset
...
def main():
    ...
    DATA_PATH = 'data'
    CSV_FILE_PATH = '{}/images.csv'.format(DATA_PATH)
    train_dataset = SkyDataset(csv_file=CSV_FILE_PATH, root_dir="./data/", transform=config.basic_transform)
    test_dataset = SkyDataset(csv_file=CSV_FILE_PATH, root_dir="./data/", transform=config.basic_transform)
